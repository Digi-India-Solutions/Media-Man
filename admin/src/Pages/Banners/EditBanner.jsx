...
const EditBanner = () => {
    ...
    useEffect(() => {
        const fetchBanner = async () => {
            try {
                const response = await axios.get(`https://api.mediaman.in/api/hoading/${_id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.put(`https://api.mediaman.in/api/hoading/${_id}`, formDataToSend, {
                headers: {
