...
const AllProduct = () => {
    ...
    const getApiData = async (page) => {
        try {
            const res = await axios.get(`https://api.mediaman.in/api/cinemaimport?page=${page}&limit=50`);
            if (res.status === 200) {
    ...
    const deleteRecord = async (_id) => {
        ...
        if (userInput) {
            try {
                const res = await axios.delete("https://api.mediaman.in/api/deleterecord/" + _id);
                if (res.status === 200) {
    ...
    const deleteallRecord = async () => {
        ...
        if (userInput) {
            try {
                const res = await axios.delete("https://api.mediaman.in/api/deleteallcinema");
                if (res.status === 200) {
