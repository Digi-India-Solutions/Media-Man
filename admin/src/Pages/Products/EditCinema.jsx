...
const EditCinema = () => {
    ...
    const getCinemaDetails = async () => {
        try {
            const res = await axios.get(`https://api.mediaman.in/api/cinemaimport/${_id}`);
            console.log(res)
            if (res.status === 200) {
    ...
    const getCategoryData = async () => {
        try {
            const res = await axios.get("https://api.mediaman.in/api/category");
            if (res.status === 200) {
    ...
    const getStateData = async () => {
        try {
            const res = await axios.get("https://api.mediaman.in/api/state");
            if (res.status === 200) {
    ...
    const getApiData = async (selectedState = formData.state) => {
        try {
            const res = await axios.get("https://api.mediaman.in/api/city");
            if (res.status === 200) {
    ...
    const getCinemaData = async () => {
        try {
            const res = await axios.get("https://api.mediaman.in/api/create-cinema");
            if (res.status === 200) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await axios.put(`https://api.mediaman.in/api/updatecinema/${_id}`, formDataToSend);
            if (res.status === 200) {
